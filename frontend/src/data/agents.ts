...
export const agents: AgentSpec[] = [
  ...
  },
  {
    ...
    menuLabel: "Goods receipt",
    icon: ScanLine,
    purpose:
      "Edge AI on the receiving dock — a fixed camera or a dock worker's phone photographs the packing list, box labels, pallet and any damage, and the agent reads the PO, supplier, item, quantity and lot, inspects packaging for damage, matches it to the open PO and raises an exception case before the goods are ever put away.",
    inputs: [
      "Dock photos — packing list, box / shipping marks (箱唛), pallet, damage",
      "Open PO and its expected delivery lines",
      "Supplier master (names, logos, ship-from addresses)",
      "Item master and unit-of-measure conversions",
      "Inbound ASN / advance shipping notice where available",
    ],
    outputs: [
      "Extracted receipt — PO number, supplier, item, quantity, lot number with confidence scores",
      "Packaging-damage detection with annotated photos",
      "PO-match result — ordered vs received, short / over / damaged per line",
      "Goods receipt posted to SAP for clean deliveries (feeds the four-way match)",
      "Auto-generated exception case with severity, root cause and recommended action",
    ],
    tech: [
      "On-device vision model (edge inference)",
      "OCR + barcode / shipping-mark decode",
      "Damage-detection CNN",
      "GenAI field normalization",
      "SAP goods-receipt API",
    ],
    autonomy: 3,
    autonomyRule:
      "Auto-posts the goods receipt when every line matches the PO, packaging is clean and extraction confidence is above 0.95 — any shortage, overage, damage or low-confidence read raises an exception case for a person.",
    escalation: [
      "Quantity short or over against the PO",
      "Packaging or product damage detected",
      "PO number unreadable or no matching open PO",
      "Supplier or item mismatch",
      "Low extraction confidence",
    ],
    stat: "318 receipts",
    status: "review",
    note: "Stops short and damaged shipments at the dock — before they are put away, consumed, or paid against a four-way match that would otherwise look clean.",
  },
  {
    id: "invoice",
